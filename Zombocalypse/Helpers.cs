...
namespace Zombocalypse
{
    class Helpers
    {
        ...
        //these methods are basically directly taken from reimers XNA tutorial at http://www.riemers.net/eng/Tutorials/XNA/Csharp/Series2D/Coll_Detection_Matrices.php
